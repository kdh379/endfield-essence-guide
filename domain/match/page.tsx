...
import { ScreenCapturePanel } from "@/domain/match/widgets/screen-capture-panel";
...
import { matchWeaponsByTrait } from "@/domain/match/features/matching/model/scorer";
import { AUTO_OCR_TARGET_MS } from "@/domain/match/features/ocr/model/ocr-engine";
import {
  isReliableMatch,
  recognizeBestLine,
} from "@/domain/match/features/ocr/model/recognize-best-line";
import { warmupOcrEngine } from "@/domain/match/features/ocr/model/paddle-ocr-engine";
...
export default function MatchPage({ initialData }: MatchPageProps) {
